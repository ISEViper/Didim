    ...
    >
      ...
      >
        ...
        <nav class="flex-1 p-6 space-y-2 overflow-y-auto">
          <router-link to="/" @click="emit('close')" class="flex items-center gap-4 px-4 py-3 bg-indigo-600 rounded-xl text-white font-bold shadow-lg shadow-indigo-500/20 transition-transform active:scale-95">
